...
contract ZKLightClient {
    ...
    function updateCheckpoint(bytes calldata checkpointIntent, bytes memory zkProof) public {
        ...
        bool pass = verifySig(zkProof, abi.encodePacked(fp0, fp1, currentCommitteeRoot));
    ...
    function verifySig(bytes memory proof, bytes memory input) public view returns (bool) {
